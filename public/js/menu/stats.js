(function () {
    ...
    perDayBtn.addEventListener("click", async (e) => {
        ...
        try {
            ...
            location.hash = "#";
            const endpoint = `/api/v1/menu/getToday/${restroid}`
    ...
    perWeekBtn.addEventListener("click", async (e) => {
        ...
        try {
            ...
            orderlistbod.innerHTML = "";
            location.hash = "#";
            const endpoint = `/api/v1/menu/getWeek/${restroid}`
            await fetch(endpoint, {
                method: 'GET',
                headers: {
                    Accept: "application/json, text/plain, */*",
    ...
    perMonthBtn.addEventListener("click", async (e) => {
        ...
        try {
            ...
            orderlistbod.innerHTML = "";
            location.hash = "#";
            const endpoint = `/api/v1/menu/getMonth/${restroid}`
            await fetch(endpoint, {
                method: 'GET',
                headers: {
                    Accept: "application/json, text/plain, */*",
    ...
    byMonthBtn.addEventListener("click", async (e) => {
        ...
        try {
            ...
            let val = `${mtv}-${yrv}`;
            const endpoint = `/api/v1/menu/byMonth/${restroid}/find/${val}`
            await fetch(endpoint, {
                method: 'GET',
                headers: {
                    Accept: "application/json, text/plain, */*",
...
(function () {
    ...
    getHome.addEventListener("click", async (e) => {
        ...
        try {
            ...
            location.hash = "#";
            const endpoint = `/api/v1/menu/getHome/${restroid}`
            await fetch(endpoint, {
                method: 'GET',
                headers: {
                    Accept: "application/json, text/plain, */*",
    ...
    getRes.addEventListener("click", async (e) => {
        ...
        try {
            ...
            const endpoint = `/api/v1/menu/getRes/${restroid}`
            await fetch(endpoint, {
                method: 'GET',
                headers: {
                    Accept: "application/json, text/plain, */*",
