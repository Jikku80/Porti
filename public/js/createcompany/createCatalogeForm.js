function createCataloge(val, val1, val2, val3, val4, val5, val6, val7, val9) {
    return `
    <form class="comp__form">
        <div class="form__head">
            <h1>Create Company</h1>
            <img src="/images/cancel.png" alt="cancel_img" class="cancel__cataloge pointer crossbtn" />
        </div>
        <div class="to_centre">
            <button id="skipandcreatecatalog" class="whitebtn wite">Skip Form & Create</button>
        </div>
